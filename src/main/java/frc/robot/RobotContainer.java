...
public class RobotContainer {
  ...
  private final CommandPS5Controller controller =
    new CommandPS5Controller(OperatorConstants.driverControllerPort);
...
// BUMPERS ======== BUMPERS ======== BUMPERS ======== BUMPERS ======== BUMPERS ======== BUMPERS ======== BUMPERS ===========
        ...
        controller.L1().whileTrue(new turnTableCommand(turretTurnSub, false, true));

        controller.R1().whileTrue(new turnTableCommand(turretTurnSub, true, false));
  }
